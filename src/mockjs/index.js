...
// user相关
// Mock.mock(/\/admin\/login/, 'get', userAPI.login)
// Mock.mock(/\/admin\/logout/, 'get', userAPI.logout)
Mock.mock(/\/admin\/info\/get/, 'get', userAPI.getUserInfo)
// Mock.mock(/\/admin\/list\/get/, 'get', userAPI.getUserList)
